[`← Previous: Connect EC2 to RDS(MySQL)` ](p3-ec2-rds.md) **.** [`Phase3 Home`](p3-main.md) **.** [`Home`](./README.md) **.** [`Next: SG chaining (EC2 ↔ RDS) →`](p3-SG-chaining.md)
...
<details>
<summary><b>5. Frontend Security: <code>WebEC2-sg</code> Configuration</b> </summary>
...
<details>
<summary><b>6. Backend Security: <code>dbEC2-sg</code> Configuration</b> </summary>
