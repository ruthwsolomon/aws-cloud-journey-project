[`← Previous: SSH & Security` ](p2-service-management.md) **.** [`Phase2 Home`](p2-main.md) **.** [`Home`](./README.md) **.** [`Next: Phase3 Home →`](p3-main.md) 
...
Automating the setup via a Bash script reduces manual effort and minimizes the risk of human error during the configuration phase of the deployment.
 ...
 ## Screenshots
<details> <summary><b>1. Bash Script Creation (install_apache.sh)</b></summary> 
...
<details> <summary><b>2. Apache Installation Script Configuration (Shebang, Updates, and Service Setup) </b></summary> 
...
<details> <summary><b>3. Script Permission Configuration and Execution </b></summary> 
...
<details> <summary><b>4. Web Server Deployment Verification (Browser Output) </b></summary> 
