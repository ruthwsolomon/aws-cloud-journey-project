...
- [Lifecycle & Cost Optimisation](lifecycle-policies.md) – I configured lifecycle rules to automatically transition objects between storage classes (STANDARD → IA → GLACIER) and applied object tagging, demonstrating how S3 can be used to manage storage costs over time.
