...
- [Website Hosting, Versioning & CloudFront Security](static-website-et.al.md) – I configured and hosted a simple static website using Amazon S3, testing both public access and a more secure setup with Amazon CloudFront and Origin Access Control (OAC). I also worked with versioning and metadata to understand data protection and object-level configuration.
