...
<details> <summary><b>3.Modified the file permissions to make the script executable: chmod +x install_apache.sh and Ran the script to trigger the automated installation ./install_apache.sh photo </b></summary> 
