[`←S3 website hosting and versioning`](p1-static-website-et.al.md) **.** [`Main Home`](./README.md) **.** [`Phase 1 Home `](p1-main.md) **.** [`Next: LifeCycle Policies →`](p1-lifecycle-policies.md)
