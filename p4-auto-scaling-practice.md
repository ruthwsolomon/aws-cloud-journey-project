[`← Previous: ALB Healthcheck and failover`](p4-health&failover.md) **.** [`Phase 4 Home`](p4-home.md) **.** [`Home`](./README.md) **.** [`Next: Auto Scaling Stress Test  →`](p4-ASG-Stress-Test.md)
