...
- [AWS Scalable Web Architecture with Auto Scaling & Application Load Balancer)](aws-auto-scaling-practice.md) - Configured an Auto Scaling Group with a launch template connected to the ALB, enabling automatic scale-out and scale-in based on demand.
