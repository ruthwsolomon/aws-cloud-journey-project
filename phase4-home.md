...
- AWS Auto Scaling Stress Test – Dynamic Scaling Demonstration - Ran CPU stress tests to trigger scaling events, validating that the architecture dynamically adjusts capacity to handle load efficiently.
- Analyze Scaling in CloudWatch – Metrics Reading - Monitored CPU utilization, desired capacity, and in-service instances in CloudWatch to verify that the scaling policy worked as expected and resources were used efficiently.
