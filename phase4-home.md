...
- [Stress Test (Dynamic Scaling Demo.)](ASG-Stress-Test.md) - Ran CPU stress tests to trigger scaling events, validating that the architecture dynamically adjusts capacity to handle load efficiently.
