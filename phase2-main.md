...
- [Launched the Server (AWS EC2)](ec2-launch.md) - I created a live Linux instance on Amazon EC2, configuring the virtual hardware and networking to make the server accessible over the internet.
